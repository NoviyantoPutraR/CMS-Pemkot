...
export default function PengumumanHeroSection({ stats }) {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        ...
        {/* Wave pattern tipis dengan opacity rendah */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-900 font-medium">Pengumuman</li>
          </ol>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl">
              Informasi resmi dan pengumuman penting dari Pemerintah Provinsi Jawa Timur untuk masyarakat
            </p>
          </motion.div>
          ...
          {stats && (
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-card shadow-card p-6 border border-gray-100">
                <h3 className="text-sm font-semibold text-gray-700 mb-4">Pengumuman Aktif</h3>
                <div className="space-y-4">
                  <div>
                    <p className="text-2xl font-bold text-primary-blue">{stats.aktif || 0}</p>
                    <p className="text-sm text-gray-600">Sedang Berlaku</p>
                  </div>
