...
export default function ArtikelHeroSection({ stats }) {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        ...
        {/* Dot pattern dengan opacity rendah */}
        <div 
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            <h1 className="font-poppins text-4xl lg:text-5xl font-bold mb-4 leading-tight text-primary-blue">
              Artikel & Wawasan Publik
            </h1>
            <p className="text-lg text-gray-700 mb-8 max-w-2xl">
              Kumpulan artikel edukatif dan informatif untuk meningkatkan pemahaman publik tentang kebijakan, program, dan wawasan seputar Pemerintah Provinsi Jawa Timur
            </p>
          </motion.div>

          {/* Hero Card dengan Stats */}
          {stats && (
            <motion.div
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-card shadow-card p-6 border border-gray-100">
                <h3 className="text-sm font-semibold text-gray-700 mb-4">Statistik Artikel</h3>
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <p className="text-sm text-gray-600">Artikel Bulan Ini</p>
                  </div>
                </div>
              </div>
            </motion.div>
