...
export default function LayananHeroSection({ stats }) {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-900 font-medium">Layanan</li>
          </ol>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl">
              Akses layanan resmi pemerintah Provinsi Jawa Timur dengan mudah dan cepat. 
              Temukan informasi lengkap tentang berbagai layanan publik yang tersedia.
            </p>
          </motion.div>
          ...
          {stats && (
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-sm p-6 border border-gray-100">
                ...
                <p className="text-sm text-gray-600">Total Layanan Tersedia</p>
              </div>
            </motion.div>
          )}
        </div>
