...
export default function PerangkatDaerahHeroSection({ stats }) {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-900 font-medium">Perangkat Daerah</li>
          </ol>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl">
              Struktur organisasi perangkat daerah Pemerintah Provinsi Jawa Timur. 
              Temukan informasi lengkap tentang unit kerja dan kontak resmi.
            </p>
          </motion.div>
          ...
          {stats && (
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-sm p-6 border border-gray-100">
                <p className="text-3xl font-bold text-primary-blue mb-2">{stats.aktif || 0}</p>
                <p className="text-sm text-gray-600">Perangkat Daerah Aktif</p>
              </div>
            </motion.div>
          )}
        </div>
