...
export default function SosialMediaHeroSection() {
  return (
    <section className="relative overflow-hidden">
      {/* Background Gradient dengan Wave Decoration */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        {/* Gradasi utama dari atas ke bawah - Royal Blue gradient halus */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-900 font-medium">Media Sosial</li>
          </ol>
        </motion.nav>
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl">
            Ikuti kanal resmi Pemerintah Provinsi Jawa Timur untuk mendapatkan informasi terkini tentang kebijakan, program, dan aktivitas pemerintah.
          </p>
        </motion.div>
      </div>
    </section>
