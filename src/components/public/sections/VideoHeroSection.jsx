...
export default function VideoHeroSection({ stats }) {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-900 font-medium">Video</li>
          </ol>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          >
            <h1 className="font-poppins text-4xl lg:text-5xl font-bold mb-4 leading-tight text-primary-blue">
              Video Resmi Pemprov Jawa Timur
            </h1>
            <p className="text-lg text-gray-700 mb-8 max-w-2xl">
              Dokumentasi visual kegiatan, program, dan informasi resmi Pemerintah Provinsi Jawa Timur
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-card shadow-card p-6 border border-gray-100">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-2xl font-bold text-primary-blue">{stats.published || 0}</p>
