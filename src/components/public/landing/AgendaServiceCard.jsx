...
export default function AgendaServiceCard({ agenda, index = 0 }) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative h-full flex flex-col p-3 md:p-4 lg:p-5 z-10">
        {/* Icon & Status Badge */}
        ...
        {/* Title */}
        <h3 className="text-sm md:text-sm lg:text-base font-bold text-gray-900 mb-2 leading-snug lg:line-clamp-2 group-hover:text-blue-700 transition-colors duration-300">
          {agenda.judul}
        </h3>
