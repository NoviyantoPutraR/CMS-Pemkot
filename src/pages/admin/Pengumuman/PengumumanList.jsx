...
export default function PengumumanList() {
  ...
  const loadPengumuman = async () => {
    try {
      setLoading(true)
      const result = await pengumumanService.getAll({
        page,
        limit: 10,
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-3xl font-bold">Manajemen Pengumuman</CardTitle>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[200px]">Tanggal Berlaku</TableHead>
                    ...
                    pengumuman.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="text-muted-foreground">
                          {item.tanggal_berlaku_mulai ? (
                            <div className="text-sm">
                              {formatDate(item.tanggal_berlaku_mulai)}
                              {item.tanggal_berlaku_selesai && (
                                <span className="block text-xs">
                                  s/d {formatDate(item.tanggal_berlaku_selesai)}
                                </span>
                              )}
                            </div>
                          ) : (
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1">
                            ...
                            <Link to={`/admin/pengumuman/edit/${item.id}`}>
